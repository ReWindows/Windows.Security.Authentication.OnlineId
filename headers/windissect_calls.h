...
static constexpr wchar_t module_name[45] = {0x0057, 0x0069, 0x006E, 0x0064, 0x006F, 0x0077, 0x0073, 0x002E, 0x0053, 0x0065, 0x0063, 0x0075, 0x0072, 0x0069, 0x0074, 0x0079, 0x002E, 0x0041, 0x0075, 0x0074, 0x0068, 0x0065, 0x006E, 0x0074, 0x0069, 0x0063, 0x0061, 0x0074, 0x0069, 0x006F, 0x006E, 0x002E, 0x004F, 0x006E, 0x006C, 0x0069, 0x006E, 0x0065, 0x0049, 0x0064, 0x002E, 0x0064, 0x006C, 0x006C, 0x0000};
...
if (live_timestamp != 1025151482U || rva >= image_size) return nullptr;
return base + rva;
}
