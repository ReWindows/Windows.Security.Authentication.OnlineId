// Flat C exports observed in Windows.Security.Authentication.OnlineId.dll. Unknown ABIs are intentionally not declared.
// Validated dialects: ISO C17/C23/C26 draft and Windissect C20 (C ABI under C++20).
#pragma once
#ifndef WINDOWS_SECURITY_AUTHENTICATION_ONLINEID_C_H
#define WINDOWS_SECURITY_AUTHENTICATION_ONLINEID_C_H
...
#endif
#endif // WINDOWS_SECURITY_AUTHENTICATION_ONLINEID_C_H
